...
class MondayApplicationTests {
    ...
    @Autowired
//wstrzykujemy bean - jeśli istnieje kontekst spring ai bean jest skonfigurowany poprawnie powinna się tu znaleźć instancja klasy
    ...
    void givenStudentsWithDifferentName_whenGetByName_ThenReturnStudentWithGivenName() {
        ...
        var student2 = new Student("Aga", StudentUnit.GDANSK, 12L, Tryb.Niestacjonarny, true);
        studentRepository.saveAll(List.of(student1, student2));

        var response = mockMvc.perform(get("/students?name=Jakuba"))
