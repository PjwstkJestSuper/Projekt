...
class MockStudentServiceTest {
    ...
    void givenKierunekWhenGetStudentsThenReturnListOfStudents() {
        ...
        Student student = new Student("Jakub", StudentUnit.GDANSK, 5L, kierunek, 0L);
    ...
    void givenEctsWhenGetStudentsThenReturnListOfStudents() {
        Long ects = 5L;
        Student student = new Student("Jakub", StudentUnit.GDANSK, ects, Kierunek.Informatyka, 0L);
    ...
    void givenStudentDtoWithInvalidIndexWhenUpdateStudentThenThrowException() {
        ...
        Long index = 5L;
        StudentDto studentDto = new StudentDto(UUID.fromString("193c30a0-2c73-4229-989c-c257c05a9413"),"Jakub", StudentUnit.GDANSK, Kierunek.Informatyka, 0L, index);
    ...
    void givenIndexWhenGetStudentThenReturnStudentDto() {
        Long index = 5L;
        Student student = new Student("Jakub", StudentUnit.GDANSK, index, Kierunek.Informatyka, 0L);
        StudentDto studentDto = new StudentDto(UUID.fromString("193c30a0-2c73-4229-989c-c257c05a9413"),"Jakub", StudentUnit.GDANSK, Kierunek.Informatyka, 0L, index);
    ...
    void whenGetAllThenReturnListOfAllStudents() {
        Student student1 = new Student("Jakub", StudentUnit.GDANSK, 5L, Kierunek.Informatyka, 0L);
        Student student2 = new Student("Zygfryd", StudentUnit.WARSZAWA, 6L, Kierunek.Grafika, 0L);
        StudentDto studentDto1 = new StudentDto(UUID.fromString("193c30a0-2c73-4229-989c-c257c05a9413"),"Jakub", StudentUnit.GDANSK, Kierunek.Informatyka, 0L, 5L);
